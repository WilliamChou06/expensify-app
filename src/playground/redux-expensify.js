...
const expenseOne = store.dispatch(addExpense({description: "Toblerone", amount: 100, createdAt: 1000}));
const expenseTwo = store.dispatch(addExpense({description: "COFFEE", amount: 2004, createdAt: -1000}));
const expenseThree = store.dispatch(addExpense({description: "SODA COLA", amount: 500}));
